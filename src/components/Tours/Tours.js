...
const Tours = () => {
  ...
  useEffect(() => {
    fetch("https://roam-server.onrender.com/services")
  ...
  return (
    <div className="mt-5" id="tours">
      <div className="chose-head">
        ...
        <h2 className="chose2">
          <span className="span-bg">Explore</span> The World For Yourself
        </h2>
      </div>
            ...
            <div key={tour?._id} className="card-group">
              <div className="card  text-white inner-img">
                ...
                <div className="card-img-overlay d-flex flex-column">
                  ...
                  <h3 className="card-text font-weight-bold tex-dark">
                    <span className="mr-auto tour-name">{tour?.name}</span>
                  </h3>
